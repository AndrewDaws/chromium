...
vars = {
  ...
  # and whatever else without interference from each other.
  'skia_revision': '3a1baf677e658f2a29de94930cb986a5696d6032',
  # Three lines of non-changing comments so that
  # the commit queue can handle CLs rolling V8
  # and whatever else without interference from each other.
...
deps = {
    ...
    'packages': [
      {
          ...
          'version': 'q7G-eb2GC4f7j0uuqPLlKIyFBrQY4o8N_uftG7oz6ekC',
      },
    ],
    'condition': 'checkout_android and non_git_source',
    'dep_type': 'cipd',
  ...
  'src/third_party/eigen3/src':
    Var('chromium_git') + '/external/gitlab.com/libeigen/eigen.git' + '@' + '38295af54c408883a343da7cb9bc2c3b8edb687f',
